...
Trait ShareTrait {
    ...
    public function deleteShare($staff_id,$shares_id){//删除轻享
        return $this->forStaff($staff_id)->delete('/shares/'.$shares_id);
    }
    public function postReplie($staff_id,$shares_id,$attributes,$options = []){//轻享回复
    ...
    //轻享评论删除
    public function deleteReplie($staff_id,$shares_id,$reply_id){
    ...
    //新增话题
    public function postTopic($staff_id,$attributes){
        $document = [
            "data" => [
                "type" => "topic",
                "attributes" => [
